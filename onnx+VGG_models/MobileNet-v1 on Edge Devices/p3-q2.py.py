...
parser.add_argument('--pytorch_model_path', type=str, default='./results/mobilenet_results.pt', help='location of the pytorch model')
parser.add_argument('--onnx_model_path', type=str, default='Mobile_pt.onnx', help='location to store the converted onnx model')
parser.add_argument('--model', type=str, default="Mobilenetv1", help='Model to train')
...
if model_to_convert == "VGG11":
    ...
    model_var = VGG16
elif model_to_convert == "Mobilenetv1": 
